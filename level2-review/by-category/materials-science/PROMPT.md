# Design the level-2 subspecialties for: Materials Science

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Materials Science). On the
...
**Tagline:** Functional materials — solid-state to soft matter.
**Covers:** semiconductors, polymers, ceramics, composites, nanomaterials, 2D materials, soft matter, biomaterials; Nature Materials, Adv Mater
**Audience size at level 1:** 4% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** pure synthesis → Chemistry; device-level applications → relevant engineering category

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Materials Science ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Materials Science should map to exactly
...
```
{
  "level1_slug": "materials-science",
  "level1_name": "Materials Science",
  "count": 14,
