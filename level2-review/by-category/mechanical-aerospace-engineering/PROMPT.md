# Design the level-2 subspecialties for: Mechanical & Aerospace Engineering

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Mechanical & Aerospace Engineering). On the
next screen they see a grid of subspecialties under it. Your job is to
design that grid.

## Level-1 context

**Category:** Mechanical & Aerospace Engineering
**Tagline:** Mechanics, fluids, propulsion, manufacturing.
**Covers:** mechanical, aerospace, civil structural, manufacturing, mechanics of solids and fluids, propulsion; automotive, robotics-ME
**Audience size at level 1:** 3% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** materials per se → Materials Science

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Mechanical & Aerospace Engineering ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Mechanical & Aerospace Engineering should map to exactly
...
```
{
  "level1_slug": "mechanical-aerospace-engineering",
  "level1_name": "Mechanical & Aerospace Engineering",
  "count": 14,
