# Design the level-2 subspecialties for: Economics & Finance

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Economics & Finance). On the
...
**Tagline:** Markets, policy, behavior, quantitative finance.
**Covers:** micro, macro, econometrics, behavioral economics, finance, accounting; AER, QJE, JFE, RFS, arXiv q-fin
**Audience size at level 1:** 3% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** business strategy → Business & Management; policy analysis without economics → Social Sciences

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Economics & Finance ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Economics & Finance should map to exactly
...
```
{
  "level1_slug": "economics-finance",
  "level1_name": "Economics & Finance",
  "count": 14,
