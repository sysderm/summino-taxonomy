# Design the level-2 subspecialties for: Agriculture & Food Science

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Agriculture & Food Science). On the
...
**Tagline:** Crops, livestock, nutrition, food systems.
**Covers:** agronomy, plant pathology, animal science, food science, nutrition science, aquaculture; AGRIS-style content
**Audience size at level 1:** 3% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** plant biology mechanism → Biology; food-policy → Public Health

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Agriculture & Food Science ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Agriculture & Food Science should map to exactly
...
```
{
  "level1_slug": "agriculture-food",
  "level1_name": "Agriculture & Food Science",
  "count": 14,
