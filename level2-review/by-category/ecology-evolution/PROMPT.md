# Design the level-2 subspecialties for: Ecology & Evolution

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Ecology & Evolution). On the
...
**Tagline:** Populations, ecosystems, biodiversity, deep time.
**Covers:** population ecology, community ecology, evolutionary biology, biodiversity, paleontology, behavioral ecology
**Audience size at level 1:** 3% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** molecular work → Biology; climate-scale systems → Earth & Environmental

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Ecology & Evolution ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Ecology & Evolution should map to exactly
...
```
{
  "level1_slug": "ecology-evolution",
  "level1_name": "Ecology & Evolution",
  "count": 14,
