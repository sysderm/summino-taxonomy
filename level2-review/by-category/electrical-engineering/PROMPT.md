# Design the level-2 subspecialties for: Electrical & Electronic Engineering

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Electrical & Electronic Engineering). On the
...
**Tagline:** Circuits, signals, communications, robotics, photonics.
**Covers:** circuits, signals, communications, control theory, robotics-EE, photonics, semiconductors-as-devices, power systems
**Audience size at level 1:** 4% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** algorithms → Computer Science & AI; device fabrication → Materials Science

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Electrical & Electronic Engineering ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Electrical & Electronic Engineering should map to exactly
...
```
{
  "level1_slug": "electrical-engineering",
  "level1_name": "Electrical & Electronic Engineering",
  "count": 14,
