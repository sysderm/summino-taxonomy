# Design the level-2 subspecialties for: Earth & Environmental Sciences

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Earth & Environmental Sciences). On the
...
**Tagline:** Climate, oceans, geology, sustainability.
**Covers:** climate science, atmospheric, oceanography, hydrology, geology, environmental chemistry, sustainability science
**Audience size at level 1:** 4% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** lab ecology → Ecology & Evolution; policy → Public Health / Social Sciences

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Earth & Environmental Sciences ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Earth & Environmental Sciences should map to exactly
...
```
{
  "level1_slug": "earth-environmental",
  "level1_name": "Earth & Environmental Sciences",
  "count": 14,
