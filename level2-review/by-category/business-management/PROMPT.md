# Design the level-2 subspecialties for: Business & Management

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Business & Management). On the
...
**Tagline:** Strategy, operations, organizational behavior, marketing.
**Covers:** management science, organizational behavior, marketing research, operations research, entrepreneurship; AMJ, Strategic Management Journal
**Audience size at level 1:** 2% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** financial markets → Economics & Finance; labor economics → Economics & Finance

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Business & Management ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Business & Management should map to exactly
...
```
{
  "level1_slug": "business-management",
  "level1_name": "Business & Management",
  "count": 14,
