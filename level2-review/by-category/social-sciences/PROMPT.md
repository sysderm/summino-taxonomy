# Design the level-2 subspecialties for: Social Sciences

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Social Sciences). On the
...
**Tagline:** Sociology, anthropology, politics, education, communication.
**Covers:** sociology, anthropology, political science, education research, communication, criminology, geography-human, linguistics, science-and-technology-studies
**Audience size at level 1:** 4% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** psychology → Brain & Cognitive Sciences; economics → Economics & Finance

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Social Sciences ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Social Sciences should map to exactly
...
```
{
  "level1_slug": "social-sciences",
  "level1_name": "Social Sciences",
  "count": 14,
