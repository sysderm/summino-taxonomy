# Design the level-2 subspecialties for: Chemistry

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Chemistry). On the
...
**Category:** Chemistry
**Tagline:** Reactions, synthesis, analysis, catalysis.
**Covers:** organic, inorganic, physical, analytical, electrochemistry; JACS, Angewandte, Chem Sci
**Audience size at level 1:** 7% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** solid-state and electronic materials → Materials Science; biology-context biochemistry → Biology

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Chemistry ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Chemistry should map to exactly
...
```
{
  "level1_slug": "chemistry",
  "level1_name": "Chemistry",
  "count": 14,
