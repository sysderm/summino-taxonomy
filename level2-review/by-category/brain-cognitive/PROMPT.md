# Design the level-2 subspecialties for: Brain & Cognitive Sciences

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Brain & Cognitive Sciences). On the
next screen they see a grid of subspecialties under it. Your job is to
design that grid.

## Level-1 context

**Category:** Brain & Cognitive Sciences
**Tagline:** Neuroscience, psychology, cognition, behavior.
**Covers:** systems neuro, computational neuro, cognitive neuro, cognitive psychology, clinical and developmental psychology; neurology and psychiatry as cognitive disciplines
**Audience size at level 1:** 7% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** pure cellular neuro mechanisms → Biology; psychiatry as drug-treatment → Medicine

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Brain & Cognitive Sciences ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Brain & Cognitive Sciences should map to exactly
...
```
{
  "level1_slug": "brain-cognitive",
  "level1_name": "Brain & Cognitive Sciences",
  "count": 14,
