# Design the level-2 subspecialties for: Humanities

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Humanities). On the
...
**Category:** Humanities
**Tagline:** History, philosophy, archaeology, classics.
**Covers:** history of science, philosophy (including phil-of-science), archaeology, classics, art history, literary studies that engage empirical methods
**Audience size at level 1:** 1% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** digital-humanities computation → Computer Science & AI

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Humanities ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Humanities should map to exactly
...
```
{
  "level1_slug": "humanities",
  "level1_name": "Humanities",
  "count": 14,
