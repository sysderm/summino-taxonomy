# Design the level-2 subspecialties for: Physics & Astronomy

You are designing **level 2** for a scientific paper reader app. The user
already picked their level-1 category at onboarding (Physics & Astronomy). On the
...
**Tagline:** Particles, condensed matter, the cosmos.
**Covers:** high-energy, condensed matter, AMO, astrophysics, cosmology, geophysics-as-physics; Phys Rev family, arXiv hep/cond-mat/astro-ph
**Audience size at level 1:** 7% of all new science papers
**Explicitly excludes (goes to other level-1 categories):** materials-focused condensed matter → Materials Science; chemical physics → Chemistry

## Hard constraints

- **Count: between 8 and 25 subspecialties.** Fewer than 8 feels thin
  for Physics & Astronomy ("only 5 things in all of X?"). More than 25 makes the
  picker grid noisy.
- **MECE-leaning.** A paper that fits Physics & Astronomy should map to exactly
...
```
{
  "level1_slug": "physics-astronomy",
  "level1_name": "Physics & Astronomy",
  "count": 14,
